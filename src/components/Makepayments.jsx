...
const Makepayment = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        // If your "user" key stores a JSON object, we check for its existence.
        if (!userData) {
        ...
        try {
            ...
            // 3. If your backend requires a token, you might need to parse it 
            // from the "user" object like this:

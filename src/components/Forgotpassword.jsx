    ...
    return (
        <div className="forgot-page-container" style={{ display: 'flex', justifyContent: 'center', padding: '50px' }}>
            {!isSubmitted ? (
                ...
                /* Success Message displayed after button press */
                <div className="form text-center">
                    <h3 className="text-dark fw-bold">Check your email</h3>
                    <p className="p">
                        We’ve sent a password reset link to your inbox. 
                        Please follow the instructions to choose a new password.
                    </p>
                    <button 
